    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="footer_column">
                        <div class="footer_title">Categoryes</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Appsitication <i class="fa fa-heart" aria-hidden="true"></i> by <a href="http://appsitication.com" target="_blank">Appsitication</a>
